$(function () {
  ...
  $.fn.postitall.globals.filter = 'page';
  $.fn.postitall.globals.savable = true;
  $.fn.postitall.globals.resizeable = true;
  $.fn.postitall.defaults.position = 'fixed';
  ...
  var articleTitle = $('.bt-article-marquee__body h1').text(),
    ...
    $blocks = $('.bt-article__body > .apos-area > .apos-area-widget-wrapper > [data-apos-widget]'),
    $blocksInView = null,
