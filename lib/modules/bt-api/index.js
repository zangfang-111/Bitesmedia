...
const FormSubmitions = require('./controllers/formSubmitions');
const ArticleTracking = require('./controllers/articleTracking')
...
module.exports = {
  construct: function(self, options) {
    ...
    self.apos.app.get('/api/v1/formSubmitions',FormSubmitions.find(self))
    self.apos.app.put('/api/v1/formSubmitions/:id',FormSubmitions.update(self));

    self.apos.app.get('/api/v1/articleTracking', ArticleTracking.find(self))
  }
};
